# Debian Wheezy (7) Ansible Test Image

[![Travis Automated build](https://travis-ci.org/yawpitch/docker-ansible-debian.svg?branch=wheezy)](https://travis-ci.org/yawpitch/docker-ansible-debian/branches)
[![Docker Automated build](https://img.shields.io/docker/automated/yawpitch/docker-ansible-debian-wheezy.svg?maxAge=2592000)](https://hub.docker.com/r/yawpitch/docker-ansible-debian-wheezy/)

Dockerized Debian Wheezy (7) for Ansible playbook and role tests.
...
```sh
sudo docker pull yawpitch/docker-ansible-debian-wheezy:latest
```
...
```sh
sudo docker build -t docker-ansible-debian-wheezy .
```
